...
console.log(previousPointsListElem);
...
copyPreviousPointsBtn.addEventListener("click", e => {
    if (navigator.clipboard) {
        navigator.clipboard.writeText(JSON.stringify(distanceValues.previousPoints))
        .then(() => {
            copyPreviousPointsBtn.textContent = "Copied!";
            setTimeout(function() {
                copyPreviousPointsBtn.textContent = "Copy points";
            }, 3000);
        });
    }
});